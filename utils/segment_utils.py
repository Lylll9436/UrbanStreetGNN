...
# In[2]:
def process_area(area_name: str,spacing,min_length,epsilon):
    ...
    skeleton_raw, skeleton_clean, skeleton_total = GeoTool.generate_skeletons_from_buildings(buildings=split_gdf, enclosures=enclosures,spacing=spacing,min_length=min_length,epsilon=epsilon)
